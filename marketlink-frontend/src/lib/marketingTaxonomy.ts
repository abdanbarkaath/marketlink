...
export const marketingSubjects = [
  ...
  },
  {
    ...
    shortDescription: 'Find creators and influencer experts who can promote your business.',
    serviceTokens: ['creator', 'influencer', 'creator-marketing', 'influencer-marketing', 'local-influencer', 'ugc', 'sponsored-post', 'creator-outreach', 'social', 'video'],
    ...
    subcategories: [
      {
        ...
        shortDescription: 'Find creators with a local audience in your area.',
      ...
      },
      {
        ...
        shortDescription: 'Find creators who can create Instagram-native promotion and trust.',
      ...
      },
      {
        ...
        shortDescription: 'Use local or niche TikTok creators for short-form promotion.',
      ...
      },
      {
        id: 'ugc-content',
        label: 'UGC Content',
        buyerLabel: 'Get creator-style content for my business',
        shortDescription: 'Get short-form videos or photos you can use in ads or posts.',
        serviceTokens: ['ugc', 'creator-content', 'short-form-video', 'video'],
        deliverables: [
          {
            id: 'ugc-video-package',
            label: 'UGC Video Package',
            buyerLabel: 'Get creator-style videos',
            description: 'A package of creator-style videos for ads, posts, or social use.',
            serviceTokens: ['ugc', 'video-production', 'short-form-video', 'video'],
  ...
  },
  {
    ...
    serviceTokens: ['content', 'copywriting', 'website-copy', 'ad-copy', 'email-copy', 'blog-writing', 'seo-content', 'photography', 'video-production', 'video-editing', 'video'],
    suggestedExpertTypes: ['agency', 'freelancer', 'creator', 'specialist'],
    subcategories: [
      {
        id: 'website-copy',
      ...
      },
      {
        ...
        buyerLabel: 'Create videos for my business',
        shortDescription: 'Produce and edit videos for campaigns, websites, and social media.',
        serviceTokens: ['video-production', 'video-editing', 'short-form-video', 'video', 'content'],
        deliverables: [
          {
            id: 'promo-video',
            label: 'Promo Video',
          ...
          },
          {
            ...
            buyerLabel: 'Edit short videos for social media',
            description: 'Edit clips into usable short-form content for social or ads.',
            serviceTokens: ['video-editing', 'short-form-video', 'video', 'content'],
          },
        ],
      },
    ],
...
export const buyerProblems = [
  ...
  },
  {
    ...
    suggestedServiceTokens: ['creator-marketing', 'local-influencer', 'sponsored-post', 'ugc', 'creator-outreach', 'short-form-video'],
    priority: 5,
  },
  {
    ...
    suggestedServiceTokens: ['content', 'copywriting', 'photography', 'video-production', 'video-editing', 'website-copy'],
    priority: 6,
  },
  {
