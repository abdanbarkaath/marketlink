...
export function HomepageDiscoveryAnimation({ compact = false }: HomepageDiscoveryAnimationProps) {
  return (
    <div
      ...
      className={[
        'pointer-events-none select-none overflow-hidden rounded-[1.9rem] bg-[linear-gradient(180deg,rgba(255,255,255,0.95),rgba(248,243,236,0.94))] shadow-[0_18px_55px_rgba(15,23,42,0.08)] ring-1 ring-slate-200/80',
    ...
    >
      ...
      >
        ...
        {compact ? (
          <div className="relative z-10 flex min-h-[190px] flex-col justify-end gap-2 px-4 pb-4 pt-12">
            ...
            >
              <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">Step 1</div>
            ...
            >
              <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">Step 2</div>
            ...
            >
              <span className="flex h-6 w-6 items-center justify-center rounded-full bg-emerald-600 text-[10px] text-white">3</span>
              Get real results
            </div>
          </div>
        ) : (
      ...
      <style jsx>{`
        ...
        .stage-result {
          animation:
            stageFloat 7.5s ease-in-out infinite,
            stagePulse 7.5s ease-in-out infinite;
        }
